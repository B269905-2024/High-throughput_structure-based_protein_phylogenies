...
#$ -o /exports/eddie/scratch/s2713107/p_value_mat_par/logs/output_library4_$TASK_ID.log #outputs
#$ -e /exports/eddie/scratch/s2713107/p_value_mat_par/logs/error_library4_$TASK_ID.log  #error outputs
#$ -m bea                              #notifications
